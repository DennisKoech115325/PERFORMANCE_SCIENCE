...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <h2 class="p-4 font-weight-bold text-secondary">Edit Statistic 
        ...
        <div class="row justify-content-center">
            {!!Form::open(['action'=>['StatisticsController@update',$stat->id], 'method'=>'POST','enctype'=>'multipart/formdata','onsubmit'=>"return confirm('Do you really want to submit the form?');"])!!}
            <div class="form-group-row">
                ...
                <div class="form-group-row">
                    <div class="row justify-content-center">
                    {{Form::text('title',$stat->title,['class'=>'form-control','placeholder'=>'Title'])}}
                    </div>
                </div>
            <div class="form-group-row">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                {{Form::text('about',$stat->about,['class'=>'form-control','placeholder'=>'About'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::select('reason',[
                    ...
                    'other'=>'Other',
                 ],$stat->course,['class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::select('internet',[
                    'yes'=>'Yes',
                    'no'=>'No',
                 ],$stat->internet,['class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::select('traveltime',[
                    ...
                    '4'=>'More than 1 hour',
                 ],$stat->traveltime,['class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 ],$stat->studytime,['class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 ],$stat->failures,['class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::select('freetime',[
                    ...
                    '4'=>'High',
                    '5'=>'Very High',
                 ],$stat->freetime,['class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
            ...
            <div class="form-group-row ">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::select('health',[
                    ...
                    '4'=>'Good',
                    '5'=>'Very Good',
                 ],$stat->health,['class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::number('absences',$stat->absences,['min'=>'0','max'=>'93','class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::number('G1',$stat->G1,['min'=>'0','max'=>'20','class'=>'form-control'])}}
            </div>
            <div class="form-group-row ">
                <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
                ...
                <div class="row justify-content-center">
                 ...
                 {{Form::number('G2',$stat->G2,['min'=>'0','max'=>'20','class'=>'form-control'])}}
            </div>
            <div class="row justify-content-center text-secondary font-weight-bold p-3 h4">
